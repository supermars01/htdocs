...
!function (a) {
  ...
  a.extend(a.fn, {
    ...
    return 1 === arguments.length ? function () {
     ...
     : (arguments.length > 2 && c.constructor !== Array && (c = a.makeArray(arguments).slice(1)), c.constructor !== Array && (c = [
      c
    ...
    prototype: {
      ...
      form: function () {
        ...
        this.valid() || a(this.currentForm).triggerHandler('invalid-form', [
          this
        ]),
        this.showErrors(),
        this.valid()
      ...
      showLabel: function (b, c) {
        ...
        g.length ? (g.removeClass(this.settings.validClass).addClass(this.settings.errorClass), g.html(c))  : (g = a('<' + this.settings.errorElement + '>').attr('id', h + '-error').addClass(this.settings.errorClass).html(c || ''), d = g, this.settings.wrapper && (d = g.hide().show().wrap('<' + this.settings.wrapper + '/>').parent()), this.labelContainer.length ? this.labelContainer.append(d)  : this.settings.errorPlacement ? this.settings.errorPlacement(d, a(b))  : d.insertAfter(b), g.is('label') ? g.attr('for', h)  : 0 === g.parents('label[for=\'' + h + '\']').length && (f = g.attr('id'), i ? i.match(new RegExp('' + f + '')) || (i += ' ' + f)  : i = f, a(b).attr('aria-describedby', i), e = this.groups[b.name], e && a.each(this.groups, function (b, c) {
      ...
      stopRequest: function (b, c) {
        ...
        c && 0 === this.pendingRequest && this.formSubmitted && this.form() ? (a(this.currentForm).submit(), this.formSubmitted = !1)  : !c && 0 === this.pendingRequest && this.formSubmitted && (a(this.currentForm).triggerHandler('invalid-form', [
          this
    ...
    normalizeRules: function (b, c) {
      ...
      'range'], function () {
        ...
        b.min,
        b.max
      ], delete b.min, delete b.max), b.minlength && b.maxlength && (b.rangelength = [
        b.minlength,
        b.maxlength
    ...
    methods: {
      ...
      cardNum:function(a, b){
      	return this.optional(b) || /^(\d{16}|\d{19})$/.test(a)
      },
