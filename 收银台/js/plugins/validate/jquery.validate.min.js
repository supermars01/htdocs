! function(t) {
    ...
    t.extend(t.fn, {
        ...
        messages: {
            ...
            equalTo: "请再次输入相同的值.",
            maxlength: t.validator.format("输入的最大长度为{0}位."),
            minlength: t.validator.format("输入的最小长度为{0}位."),
            rangelength: t.validator.format("输入的值须在{0}和{1}位之间."),
            range: t.validator.format("输入的值须在{0}和{1}位之间."),
            max: t.validator.format("Please enter a value less than or equal to {0}."),
            min: t.validator.format("Please enter a value greater than or equal to {0}."),
            cardNum: "请输入正确的银行卡号",
            idNum: "请输入正确的身份证号",
            telphone: "请输入正确的手机号",
            isInteger:"仅支持百分比(如:28%)，最多保留两位小数",
        },
        autoCreateRanges: !1,
        prototype: {
            init: function() {
        ...
        methods: {
            ...
            cardNum: function(t, e) {
                return this.optional(e) || /^(\d{16}|\d{19})$/.test(t)
            },
            telphone: function(t, e) {
                return this.optional(e) || /^1[3|4|5|7|8]\d{9}$/.test(t)
            },
            isInteger: function(t, e) {
            	return this.optional(e) || /^([1-9]{1}[0-9]{0,1}|0|99)(.\d{1,2}){0,1}%$/.test(t);
            },
            idNum: function(t, e) {
